...
def gene_factory_ex2(gene_type, fact_range):
	# Para este problema todos los genes deben ser del tipo str y corresponder a una letra minúscula, mayúscula o a un espacio
    if fact_range != list('abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ ') or gene_type != str:
        ...
        gene = np.random.choice(fact_range) # elegimos un caracter al hacer dentro del conjunto de posibilidades fact_range
        return gene  # retornamos el gen creado

# Función para crear los individuos del ejercicio 2. Recibe 2 inputs:
# 
...
if __name__ == '__main__':
	...
	term_cond = {'type':'fitness_th','fitness_th':10, 'iters':1000}  # Cambiamos la condición de parada
