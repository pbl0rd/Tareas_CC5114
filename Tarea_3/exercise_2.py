...
# Función de fitness para el ejercicio 2. Recibe a un individuo y un diccionario con el número a encontrar y un
# ponderador. Retorna el opuesto de la suma entre la multiplicación de un ponderador y el valor absoluto de la
# diferencia entre el número a encontrar y el número correspondiente a la evaluación del individuo (árbol),
# y la multiplicación de otro ponderador por el tamaño del árbol (considerado como el número de nodos).
...
if __name__ == '__main__':
    ...
    plt.title("Evolución de fitness por generación", fontsize=16, fontweight='bold')
    plt.suptitle("Ejercicio 2.1.2", fontsize=20)
    plt.savefig('Images\Fitness_por_Generacion_EX2_V2.png')
    plt.close()
    print('gráfico 2 V2 listo')
